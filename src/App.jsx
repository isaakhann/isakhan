...
const projectData = [
  ...
  },
  {
    id: 'lens-log',
    title: 'LensLog',
    subtitle: 'Full-Stack Geolocated Photography & Metadata Cataloging Platform',
    shortDescription: 'Designed and built a modern, responsive single-page web application (SPA) that acts as an interactive journal and metadata analyzer for photography enthusiasts.',
    tags: ['ReactJS', 'TypeScript', 'Tailwind CSS', 'Leaflet', 'FastAPI', 'PostgreSQL', 'Python'],
    imageUrl: 'https://placehold.co/600x400/0a0a0a/C8FF00?text=LENSLOG',
    role: 'Developer & Contributor',
    timeline: 'Winter 2024',
    challenge: 'To build a high-performance web platform that extracts complex EXIF image metadata dynamically, renders interactive spatial maps of photo journeys with real-time resizing, and securely syncs uploads and social features to a cloud database without memory leaks or layout collapses.',
    solution: [
      'Designed and built a modern, responsive single-page web application (SPA) acting as an interactive journal and metadata analyzer.',
      'Built the frontend with React, TypeScript, and Vite, using Tailwind CSS for glassmorphic aesthetics and Leaflet for dynamic CartoDB Dark Matter map visualizations with path clustering.',
      'Implemented query caching and server-state synchronization using React Query and type-safe Axios clients.',
      'Engineered a robust Python FastAPI server with SQLAlchemy ORM connected to an Amazon RDS PostgreSQL instance supporting uploads and social interactions.',
      'Wrote extensive backend unit tests using Pytest and resolved complex rendering issues, memory leaks, and flexbox collapses under React Strict Mode.',
    ],
    liveUrl: 'https://lenslog.vercel.app',
    sourceUrl: 'https://github.com/isaakhann/lenslog',
    isFeatured: true,
    index: '02',
  },
  {
